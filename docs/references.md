...
- [grilling skill — Matt Pocock](https://github.com/mattpocock/skills/blob/main/skills/productivity/grilling/SKILL.md) — MIT, Copyright (c) 2026 Matt Pocock; the source of the interview contract's frontier discipline, adapted rather than bundled or invoked.
...
- [Goblin Tools ToDo](https://goblin.tools/ToDo) — inspiration for reducing task size; no integration.
- [Specification by Example — Gojko Adzic, 2011](https://learning.oreilly.com/library/view/-/9781617290084/) — search metadata only.
- [Building Applications with AI Agents — Michael Albada, 2025](https://learning.oreilly.com/library/view/-/9781098176495/) — search metadata only.
