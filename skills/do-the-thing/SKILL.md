---
name: do-the-thing
description: 트리거 "두더띵으로 해줘", "리니어 이슈 받아서 작업해", "이 일 스펙부터 써", "중단된 작업 이어서", "완료 증거 확인해" — Linear issue in, work with receipts out — context-aware domain clarification, interview, Big and Mini Painless Specs, execute, test proof, review, checkpoint, resume.
license: MIT
---
